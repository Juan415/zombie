...
var mainState = {
    ...
    preload: function () {
        ...
        game.load.image('weapon', 'assets/images/Diamond_Sword.png');
    },
    ...
    update: function () {
        ...
        game.physics.arcade.collide(this.sword, this.floor); 
        game.physics.arcade.collide(this.sword, this.enemies, this.check);
        ...
        if(game.input.keyboard.isDown(Phaser.Keyboard.DOWN)){
            this.sword.anchor.setTo(.5, 1); 
            this.sword.scale.x = -0.2;
            this.sword.scale.x = -0.2;
            isfacingright = true;
